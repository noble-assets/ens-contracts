...
describe('TestUnwrap', () => {
  describe('wrapFromUpgrade()', () => {
    describe('.noble', () => {
      const encodedName = dnsEncodeName('wrapped.noble')
      const label = 'wrapped'
      const labelHash = labelhash(label)
      const nameHash = namehash('wrapped.noble')
    ...
    describe('other', () => {
      ...
      const name = `${label}.${parentLabel}.noble`
      const parentLabelHash = labelhash(parentLabel)
      const parentHash = namehash(`${parentLabel}.noble`)
